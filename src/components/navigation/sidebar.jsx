...
export const SideBar = () => {
  ...
  const list = (anchor) => (
    ...
    >
      ...
      <List style={{width: '100%', display: 'flex', justifyContent: 'space-evenly', marginTop: '3vw'}}>
        <svg
          className="social"
        ...
        >
          <path d="M15.9916 5.32083H17.9999V2.14083C17.6534 2.0975 16.4618 2 15.0741 2C12.1786 2 10.1951 3.65583 10.1951 6.69917V9.5H6.99988V13.055H10.1951V22H14.1126V13.0558H17.1786L17.6653 9.50083H14.1117V7.05167C14.1126 6.02417 14.4169 5.32083 15.9916 5.32083Z" fill="white"/>
        </svg>
        ...
        <svg
          ...
          style={{ cursor: "pointer", padding: "15px" }}
          onClick={() =>
            window.open("https://www.instagram.com/20000m_above_the_gobi_desert/", "_blank")
          }
          width="25"
          height="25" 
          viewBox="0 0 24 24" 
  ...
  return (
    <div className="sideBar">
      <div className="gobi">GOBI SPACE</div>
