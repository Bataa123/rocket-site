  ...
  const list = (anchor) => (
    ...
    >
      ...
      <List>
        ...
        >
          <path
            d="M6.54093 7.81651L6.90335 5.30153H4.63445V3.66972C4.63445 2.98226 4.95085 2.3107 5.96795 2.3107H7V0.170031C7 0.170031 6.06345 0 5.16831 0C3.2998 0 2.07791 1.20367 2.07791 3.38471V5.30153H0V7.81651H2.07791V13.8948C2.49441 13.9645 2.92127 14 3.35618 14C3.79109 14 4.21795 13.9633 4.63445 13.8948V7.81651H6.54093Z"
            fill="black"
          />
        </svg>
        <svg
          ...
          style={{ cursor: "pointer", padding: "15px" }}
          onClick={() =>
            window.open("https://www.instagram.com/gobi.space/", "_blank")
          }
          width="25"
          height="25"
          viewBox="0 0 14 14"
      ...
      <Divider style={{ width: "100%" }} />
      <List>
        <div style={{ color: "black", padding: "15px" }} className="copyright">
          © Copyright 2020
        </div>
      </List>
    </div>
